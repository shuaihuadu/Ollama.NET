...
internal static class ServerSendEventAsyncEnumerator<T> where T : class
{
    ...
    /// </remarks>
    [SuppressMessage("Roslynator", "RCS1261:Resource can be disposed asynchronously", Justification = "<Pending>")]
    internal static async IAsyncEnumerable<T> EnumerateFromSseStreamAsync(HttpResponseMessage httpResponseMessage, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
