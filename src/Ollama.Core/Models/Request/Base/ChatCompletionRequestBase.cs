...
internal abstract class ChatCompletionRequestBase : ChatCompletionOptions
{
    ...
    protected ChatCompletionRequestBase(string model, ChatMessageHistory messages, bool stream)
    {
        this.Model = model;
    ...
    protected ChatCompletionRequestBase(ChatCompletionOptions options)
    {
