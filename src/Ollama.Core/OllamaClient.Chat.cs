...
public sealed partial class OllamaClient
{
    ...
    public async Task<StreamingResponse<ChatCompletionResponse>> ChatCompletionStreamingAsync(string model, ChatMessageHistory chatMessageHistory, CancellationToken cancellationToken = default)
    {
