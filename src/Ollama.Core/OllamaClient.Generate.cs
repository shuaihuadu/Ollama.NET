...
public sealed partial class OllamaClient
{
    ...
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the initial request or ongoing streaming operation.</param>
    /// <returns>Streaming list of completion result generated by the model</returns>
    public async Task<StreamingResponse<GenerateCompletionResponse>> GenerateCompletionStreamingAsync(GenerateCompletionStreamingRequest request, CancellationToken cancellationToken = default)
    {
        ...
        {
            this._logger.LogError(ex, "Request for generate completion streaming faild. Request: {Request} ,Message: {Message}", request.AsJson(), ex.Message);
    ...
    public async Task<GenerateCompletionResponse> GenerateCompletionAsync(GenerateCompletionRequest request, CancellationToken cancellationToken = default)
    {
        ...
        {
            this._logger.LogError(ex, "Request for generate completion faild. Request: {Request} ,Message: {Message}", request.AsJson(), ex.Message);
