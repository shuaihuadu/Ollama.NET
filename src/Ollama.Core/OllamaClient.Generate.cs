...
public sealed partial class OllamaClient
{
    ...
    {
        return await this.GenerateCompletionStreamingAsync(new GenerateCompletionRequest(model, prompt, true), cancellationToken).ConfigureAwait(false);
    }

    /// <summary>
    /// Get streaming completions results use the given <see cref="GenerateCompletionOptions"/>.
    /// </summary>
    /// <param name="options">The options to use for generating completions, including model, prompt, and additional settings.</param>
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the initial request or ongoing streaming operation.</param>
    /// <returns>Streaming list of completion result generated by the model</returns>
    public async Task<StreamingResponse<GenerateCompletionResponse>> GenerateCompletionStreamingAsync(GenerateCompletionOptions options, CancellationToken cancellationToken = default)
    {
        return await this.GenerateCompletionStreamingAsync(new GenerateCompletionRequest(options), cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await this.GenerateCompletionAsync(new GenerateCompletionRequest(model, prompt, false), cancellationToken).ConfigureAwait(false);
    }

    /// <summary>
    /// Get completions use the given <see cref="GenerateCompletionOptions"/>.
    /// </summary>
    /// <param name="options">The options to use for generating completions, including model, prompt, and additional settings.</param>
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the initial request or ongoing streaming operation.</param>
    /// <returns>Completion result generated by the model</returns>
    ...
    {
        return await this.GenerateCompletionAsync(new GenerateCompletionRequest(options), cancellationToken).ConfigureAwait(false);
    }
    ...
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the initial request or ongoing streaming operation.</param>
    /// <returns>Streaming list of completion result generated by the model</returns>
    private async Task<StreamingResponse<GenerateCompletionResponse>> GenerateCompletionStreamingAsync(GenerateCompletionRequest request, CancellationToken cancellationToken = default)
    {
